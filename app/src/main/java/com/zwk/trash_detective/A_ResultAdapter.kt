...
class A_ResultAdapter(val trashlist: MutableList<out D_BaiTrashData>) : RecyclerView.Adapter<A_ResultAdapter.ViewHolder>(){
    inner class ViewHolder(view : View) : RecyclerView.ViewHolder(view){
        ...
        val score : TextView = view.findViewById(R.id.String_score)
    }
